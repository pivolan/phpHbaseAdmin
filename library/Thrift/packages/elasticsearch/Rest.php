...
class RestClient implements RestIf {
  ...
  public function recv_execute()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Rest_execute_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new Rest_execute_result();
